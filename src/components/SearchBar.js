...
//Функция отображения поля поиска
const SearchBar = () => {
  ...
  useEffect(() => {
    // аналог метода componentDidMount()
  ...
  // При нажатии вне поля изменяет состояние ввода на false
  const handleClick = e => {
  ...
  return (
    ...
    >
      ...
      <Input
        ...
        ref={inputFocus} value={input} state={state}
        placeholder="Поиск"
      />
    </Form>
  );
